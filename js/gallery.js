// ===== 成就馆: 档案本风 =====
// 顶部 archetype 横幅 + 数字概览 + 进度条 + 分组卡片网格
import { ACHIEVEMENTS, RARITY, CATEGORY, getArchetype } from './data.js';
      ...
      for (const a of items) {
        ...
        html += `
          <div class="gp-card ${ok?'ok':''}" style="--rc:${meta.color}; --rc-30:${hexA(meta.color,.30)}">
            ...
            <div class="gp-desc">${ok ? a.desc : '尚未触发, 再刷一会儿'}</div>
            <div class="gp-foot">
              <span>${a.rate}</span>
  ...
  async shareWall() {
    ...
    if (unlocked.length === 0) {
      ...
      unlocked.forEach((a,i) => {
        ...
        wrapText(g, a.desc, x+14, y+96, cellW-28, 16, 2);
      });
    }
